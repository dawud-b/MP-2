...
----------------------------------------------------------------------------------
--Command: generate_target bd_ed01.bd
--Design : bd_ed01
...
entity bd_ed01 is
  ...
  attribute CORE_GENERATION_INFO of bd_ed01 : entity is "bd_ed01,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ed01,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_ed01 : entity is "system_v_proc_ss_1_0.hwdef";
end bd_ed01;

architecture STRUCTURE of bd_ed01 is
  component bd_ed01_hcr_0 is
  port (
    s_axi_CTRL_AWADDR : in STD_LOGIC_VECTOR ( 10 downto 0 );
    s_axi_CTRL_AWVALID : in STD_LOGIC;
    s_axi_CTRL_AWREADY : out STD_LOGIC;
  ...
  end component bd_ed01_hcr_0;
  signal intf_net_bdry_in_s_axi_ctrl_ARADDR : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal intf_net_bdry_in_s_axi_ctrl_ARREADY : STD_LOGIC;
  signal intf_net_bdry_in_s_axi_ctrl_ARVALID : STD_LOGIC;
  signal intf_net_bdry_in_s_axi_ctrl_AWADDR : STD_LOGIC_VECTOR ( 10 downto 0 );
...
begin
  intf_net_bdry_in_s_axi_ctrl_ARADDR(10 downto 0) <= s_axi_ctrl_araddr(10 downto 0);
  intf_net_bdry_in_s_axi_ctrl_ARVALID <= s_axi_ctrl_arvalid;
  intf_net_bdry_in_s_axi_ctrl_AWADDR(10 downto 0) <= s_axi_ctrl_awaddr(10 downto 0);
  ...
  intf_net_hcr_m_axis_video_TREADY <= m_axis_tready;
  m_axis_tdata(23 downto 0) <= intf_net_hcr_m_axis_video_TDATA(23 downto 0);
  m_axis_tdest(0) <= intf_net_hcr_m_axis_video_TDEST(0);
  m_axis_tid(0) <= intf_net_hcr_m_axis_video_TID(0);
  m_axis_tkeep(2 downto 0) <= intf_net_hcr_m_axis_video_TKEEP(2 downto 0);
  m_axis_tlast(0) <= intf_net_hcr_m_axis_video_TLAST(0);
  m_axis_tstrb(2 downto 0) <= intf_net_hcr_m_axis_video_TSTRB(2 downto 0);
  m_axis_tuser(0) <= intf_net_hcr_m_axis_video_TUSER(0);
  m_axis_tvalid <= intf_net_hcr_m_axis_video_TVALID;
...
hcr: component bd_ed01_hcr_0
     port map (
      ...
      s_axi_CTRL_ARADDR(10 downto 0) => intf_net_bdry_in_s_axi_ctrl_ARADDR(10 downto 0),
      s_axi_CTRL_ARREADY => intf_net_bdry_in_s_axi_ctrl_ARREADY,
      s_axi_CTRL_ARVALID => intf_net_bdry_in_s_axi_ctrl_ARVALID,
      s_axi_CTRL_AWADDR(10 downto 0) => intf_net_bdry_in_s_axi_ctrl_AWADDR(10 downto 0),
      s_axi_CTRL_AWREADY => intf_net_bdry_in_s_axi_ctrl_AWREADY,
